...
**VanillaPlus** is a Multiplayer Server for Minecraft Java Edition {{ mc_version }} that aims to provide an enhanced experience to the normal survival gameplay using a resource pack, custom items and plugins.
