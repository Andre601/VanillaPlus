...
{{ infobox("vanillaplus:copper_scythe") }}
...
{{ crafting_recipe("vanillaplus:wooden_scythe", footer=False) }}
{{ crafting_recipe("vanillaplus:stone_scythe", header=False, footer=False) }}
{{ crafting_recipe("vanillaplus:golden_scythe", header=False, footer=False) }}
{{ crafting_recipe("vanillaplus:copper_scythe", header=False, footer=False) }}
{{ crafting_recipe("vanillaplus:iron_scythe", header=False, footer=False) }}
{{ crafting_recipe("vanillaplus:diamond_scythe", header=False) }}
...
| Golden Scythe    | `vanillaplus:golden_scythe`    |
